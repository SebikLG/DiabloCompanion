...
if(sebaGearView){
  const sebaStarterGear=[
    {slot:"Hełm",aspect:"Aspekt Tajemnej Osłony",effect:"Umiejętności Mistrzostwa zapewniają 30% redukcji obrażeń, gdy ich efekt jest aktywny.",why:"Piorun Kulisty jest umiejętnością Mistrzostwa, więc defensywa działa naturalnie podczas walki.",affixes:[]},
    {slot:"Napierśnik",aspect:"Aspekt Skoncentrowanych",effect:"Użycie umiejętności Przywołania zapewnia 30% redukcji obrażeń na 5 sek.",why:"To nasz legendarny zamiennik za Stealth. Hydra i Familiar pozwalają regularnie odświeżać efekt.",affixes:["Regeneracja many","Inteligencja","Maksymalne zdrowie","Pancerz"]},
    {slot:"Rękawice",aspect:"Aspekt Rozsadzającej Energii",effect:"Umiejętności Porażenia zyskują 180%[x] obrażeń; premia maleje przy kolejnych trafieniach.",why:"Zostawiamy aspekt Lurkina — bezpośrednio wzmacnia główne źródło obrażeń.",affixes:[]},
    {slot:"Spodnie",aspect:"Aspekt Czarowładczy",effect:"Trafienie umiejętnością Porażenia przeciwnika z bliska zapewnia 45% redukcji obrażeń na 6 sek.",why:"Ball Lightning gra blisko przeciwników, więc warunek łatwo utrzymać.",affixes:[]},
    {slot:"Buty",aspect:"Aspekt Rozszarpujących Ostrzy",effect:"Obrażenia umiejętności Przywołania nakładają Vulnerable na 4 sek., a obrażenia przeciw Vulnerable rosną o 20%[x].",why:"Hydra i Familiar nakładają Vulnerable bez dokładania osobnej akcji do rotacji.",affixes:[]},
...
if(sebaAspectsView){
  const sebaStarterAspects=[
    {slot:"Hełm",name:"Aspekt Tajemnej Osłony",effect:"Umiejętności Mistrzostwa zapewniają 30% redukcji obrażeń, gdy ich efekt jest aktywny.",why:"Piorun Kulisty jest umiejętnością Mistrzostwa, więc defensywa działa naturalnie podczas walki."},
    {slot:"Napierśnik",name:"Aspekt Skoncentrowanych",effect:"Użycie umiejętności Przywołania zapewnia 30% redukcji obrażeń na 5 sek.",why:"Nasz legendarny zamiennik za Stealth. Hydra i Familiar pozwalają regularnie odświeżać efekt."},
    {slot:"Rękawice",name:"Aspekt Rozsadzającej Energii",effect:"Umiejętności Porażenia zyskują 180%[x] obrażeń; premia maleje przy kolejnych trafieniach.",why:"Aspekt z buildu Lurkina — bezpośrednio wzmacnia główne źródło obrażeń."},
    {slot:"Spodnie",name:"Aspekt Czarowładczy",effect:"Trafienie umiejętnością Porażenia przeciwnika z bliska zapewnia 45% redukcji obrażeń na 6 sek.",why:"Ball Lightning gra blisko przeciwników, więc warunek łatwo utrzymać."},
    {slot:"Buty",name:"Aspekt Rozszarpujących Ostrzy",effect:"Obrażenia umiejętności Przywołania nakładają Vulnerable na 4 sek., a obrażenia przeciw Vulnerable rosną o 20%[x].",why:"Hydra i Familiar nakładają Vulnerable bez dokładania osobnej akcji do rotacji."},
