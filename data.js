...
sebaAquaStyle.textContent='[data-profile-panel="seba-endgame"] .seba-gear-head,[data-profile-panel="seba-endgame"] .aspect-head{background:#1d4648;border-bottom-color:#2f6f72;color:#d8f4f2}[data-profile-panel="seba-endgame"] .seba-gear-aspect{color:#8fc9c7}[data-profile-panel="seba-endgame"] .seba-gear-tab.active{border-color:#397f82;background:#162c2e;color:#bfe7e5;box-shadow:0 0 0 1px rgba(57,127,130,.16) inset}[data-profile-panel="seba-endgame"] .seba-affix-title{color:#6fb8b5}[data-profile-panel="seba-endgame"] .seba-affix span{border-color:#356a6c;color:#9fd2cf;background:#142729}.profilebtn[data-profile="seba-endgame"].active{border-color:#397f82;background:#162c2e;color:#bfe7e5;box-shadow:0 0 0 1px rgba(57,127,130,.16) inset}';
